...
class PipelineRunner:
    def run(self, request: PipelineRequest) -> PipelineResult:
        ...
        try:
            ...
            context.start_stage(StageName.PACKAGE, "写入失败报告...")
            report_path = context.paths.report_path
            context.finish_stage(
                StageName.PACKAGE,
                StageStatus.SUCCEEDED,
            ...
            context.print_footer(False, {"report": str(report_path)})
            return result