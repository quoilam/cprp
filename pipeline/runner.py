...
from .stages.research import research_stage
from .stages.codegen import codegen_stage
from .stages.optimize import optimize_stage
from .stages.execute import execution_stage
from .stages.evaluate import evaluate_stage
from .stages.package import package_stage
...
class PipelineRunner:
    ...
    def run(self, request: PipelineRequest) -> PipelineResult:
        """Run the pipeline."""
        context = PipelineContext.create(request, config=self.config)
        context.copy_input_image()
        context.print_header()

        result = PipelineResult(run_id=context.run_id,
